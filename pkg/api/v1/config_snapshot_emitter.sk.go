...
var (
	mConfigSnapshotIn  = stats.Int64("config.sg.solo.io/snap_emitter/snap_in", "The number of snapshots in", "1")
	mConfigSnapshotOut = stats.Int64("config.sg.solo.io/snap_emitter/snap_out", "The number of snapshots out", "1")

	configsnapshotInView = &view.View{
		Name:        "config.sg.solo.io_snap_emitter/snap_in",
	...
	configsnapshotOutView = &view.View{
		Name:        "config.sg.solo.io/snap_emitter/snap_out",
