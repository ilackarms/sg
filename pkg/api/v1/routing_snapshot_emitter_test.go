...
var _ = Describe("V1Emitter", func() {
	...
	It("tracks snapshots on changes to any resource", func() {
		...
		*/
		...
		assertSnapshotDestinationrules := func(expectDestinationrules RoutingRuleList, unexpectDestinationrules RoutingRuleList) {
		drain:
			for {
				select {
				case snap = <-snapshots:
		...
		assertSnapshotDestinationrules(RoutingRuleList{routingRule1a, routingRule1b}, nil)
		...
		assertSnapshotDestinationrules(RoutingRuleList{routingRule1a, routingRule1b, routingRule2a, routingRule2b}, nil)
		...
		assertSnapshotDestinationrules(RoutingRuleList{routingRule1a, routingRule1b}, RoutingRuleList{routingRule2a, routingRule2b})
		...
		assertSnapshotDestinationrules(nil, RoutingRuleList{routingRule1a, routingRule1b, routingRule2a, routingRule2b})
